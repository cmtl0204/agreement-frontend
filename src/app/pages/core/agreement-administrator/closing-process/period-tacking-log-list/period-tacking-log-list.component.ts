...
@Component({
  selector: 'app-period-tacking-log-list',
  templateUrl: './period-tacking-log-list.component.html',
  styleUrl: './period-tacking-log-list.component.scss'
})
export class PeriodTackingLogListComponent implements OnInit {
