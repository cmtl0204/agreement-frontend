...
import {AgreementsHttpService, CataloguesHttpService, PeriodsHttpService} from '@servicesHttp/core';
import {
...
export class PeriodListComponent implements OnInit {
  ...
  findPeriodsByAgreement() {
    this.periodsHttpService.findPeriodsByAgreement(this.agreementId)
      .subscribe((response) => {
        this.items = response;
      });
  }
  ...
  createPeriod() {
    this.periodsHttpService.create(this.agreementId)
      .subscribe((response) => {
        this.findPeriodsByAgreement();
      });
  }
  ...
  onUpload() {
    if (this.validateFilesForm()) {
      ...
      this.periodsHttpService.createTrackingLog(this.selectedItem.id!, formData).subscribe(response => {
