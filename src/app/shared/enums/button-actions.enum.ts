export enum IdButtonActionEnum {
  ...
  AGREEMENT_CLOSING_MANAGEMENT = 'agreement_closing_management',
...
export enum LabelButtonActionEnum {
  ...
  AGREEMENT_CLOSING_MANAGEMENT = 'Gestión de cierre de Convenio',
...
export enum IconButtonActionEnum {
  ...
  AGREEMENT_CLOSING_MANAGEMENT = 'pi pi-sitemap',
